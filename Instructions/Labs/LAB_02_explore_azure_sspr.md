...
1. 在左侧导航面板中，确保 Entra ID 已展开，然后向下滚动并选择“密码重置”。********  
...
1. 在“重置所需的方法数”中，选择 1****。 只列出了一种方法，即“安全性问题”，但该选项下方的选项是“使用身份验证方法策略管理其他身份验证方法”****。  
    1. 选择“身份验证方法策略”**** 以查看可用的身份验证方法策略
    1. 选择页面右上角的“X”**** 以返回到上一页。
